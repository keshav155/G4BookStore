...
namespace BookStoreApp.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,isReserved")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Id,isReserved")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Reserve(string id, [Bind("Name,Id,isReserved")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
